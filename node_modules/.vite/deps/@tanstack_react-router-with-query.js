...
function routerWithQueryClient(router, queryClient, additionalOpts) {
  ...
  router.options = {
    ...
    Wrap: ({ children }) => {
      const OuterWrapper = (additionalOpts == null ? void 0 : additionalOpts.WrapProvider) || import_react.Fragment;
      const OGWrap = ogOptions.Wrap || import_react.Fragment;
      return (0, import_jsx_runtime.jsx)(OuterWrapper, { children: (0, import_jsx_runtime.jsx)(QueryClientProvider, { client: queryClient, children: (0, import_jsx_runtime.jsx)(OGWrap, { children }) }) });
    }
  };
  return router;
}
